...
const contactDetails = [
  {
    icon: Mail,
    label: "Email",
    value: "hello@reportrun.ng",
    href: "mailto:hello@reportrun.ng",
  },
  {
    icon: Phone,
    label: "Phone",
    value: "+234 800 REPORT (737678)",
    href: "tel:+234800737678",
  },
  {
    icon: MapPin,
    label: "Office",
    value: "14 Ahmadu Bello Way, Abuja, FCT",
    href: undefined,
  },
];
        ...
        <div className="container-page">
          <div className="max-w-xl">
            ...
            <p className="text-lg text-text-secondary leading-relaxed">
              Whether you want a demo, have a pricing question, or just want
              to know if ReportRun fits your school — we respond within one
              business day.
            </p>
          </div>
        </div>
                      ...
                      <div key={detail.label} className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          {detail.href ? (
                            <a
                              href={detail.href}
                              className="text-sm text-text-primary hover:text-navy-600 transition-colors"
                            >
                              {detail.value}
                            </a>
                          ) : (
