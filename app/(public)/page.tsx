...
//   CreditCard, Bell, FileText, Shield,
//   BarChart2, Clock,
// } from "lucide-react";
...
//     description:
//       "Assign and track staff duties across the week. Morning assembly, gate duty, exam supervision — all in one view.",
//   },
//   {
//     icon: FileText,
//     title: "Results Management",
//     description:
//       "Upload student results via PDF scraper or manual entry. Generate broadsheets and report cards instantly.",
//   },
//   {
//     icon: CreditCard,
//     title: "Fee Collection Ledger",
//     description:
//       "Track every payment, flag outstanding balances, and send automated reminders to parents via SMS or email.",
//   },
//   {
//     icon: Bell,
//     title: "Automated Reminders",
//     description:
//       "Set trigger rules for fee reminders. The system sends them — you focus on running the school.",
//   },
//   {
//     icon: BookOpen,
//     title: "Academics Control",
//     description:
//       "Manage subjects, class assignments, grading scales, and term configurations from a single dashboard.",
//   },
//   {
//     icon: BarChart2,
//     title: "Dashboard Insights",
//     description:
//       "Get a real-time snapshot of collection rates, attendance, and academic performance every morning.",
//   },
// ];
...
//     description: "Enter your school details, configure terms, and import your class structure in under 10 minutes.",
//   },
//   {
//     number: "2",
//     title: "Add staff and students",
//     description: "Bulk import or add individually. Assign form teachers, subjects, and sections.",
//   },
//   {
//     number: "3",
//     title: "Run your school",
//     description: "Allocate duties, record results, collect fees, and communicate with parents — all from one place.",
//   },
// ];
...
//   {
//     quote:
//       "Before ReportRun, we spent three days every term just compiling result sheets. Now it takes two hours.",
//     name: "Mrs. Adaeze Okafor",
//     title: "Vice Principal, Academics",
//     school: "Greenfield Academy, Abuja",
//   },
//   {
//     quote:
//       "The fee reminder system alone has improved our collection rate from 61% to 89% in one term.",
//     name: "Mr. Tunde Balogun",
//     title: "Bursar",
//     school: "Heritage International School, Lagos",
//   },
//   {
//     quote:
//       "Our parents actually appreciate the SMS updates. It has reduced the number of phone calls to the school office drastically.",
//     name: "Mrs. Chioma Eze",
//     title: "School Administrator",
//     school: "Sunrise Academy, Enugu",
//   },
// ];

// const faqs = [
//   {
//     question: "Do I need technical knowledge to use ReportRun?",
//     answer:
//       "No. ReportRun is designed for school administrators, not IT staff. If you can use WhatsApp, you can use ReportRun.",
//   },
//   {
//     question: "Can I import existing student data?",
//     answer:
//       "Yes. You can upload student records via Excel or CSV. Our PDF scraper also extracts results directly from existing report card PDFs.",
//   },
//   {
//     question: "How does the SMS reminder system work?",
//     answer:
//       "You configure trigger rules — for example, send a reminder 7 days before fee due date. The system handles delivery automatically to parent phone numbers on record.",
//   },
//   {
//     question: "Is my school's data secure?",
//     answer:
//       "All data is encrypted at rest and in transit. Each school's data is fully isolated — no other school can access your records.",
//   },
//   {
//     question: "What happens if I need help?",
//     answer:
//       "Every plan includes email support. Growth and Enterprise plans include dedicated phone support and onboarding assistance.",
//   },
// ];
...
//             </div>
//             <h1 className="text-4xl lg:text-5xl font-semibold text-text-primary leading-tight mb-6">
//               Run your school.<br />
//               Not spreadsheets.
//             </h1>
//             <p className="text-lg text-text-secondary leading-relaxed mb-8 max-w-xl">
//               ReportRun handles staff duties, student results, fee collections,
...
//             </h2>
//             <p className="text-text-secondary">
//               Most schools are fully operational on ReportRun within 24 hours of signing up.
//             </p>
//           </div>
...
//             Join 400+ Nigerian schools already running on ReportRun.
...
const testimonials = [
  { quote: "Before ReportRun, we spent three days every term just compiling result sheets. Now it takes two hours.", name: "Mrs. Adaeze Okafor",  title: "Vice Principal, Academics", school: "Greenfield Academy, Abuja" },
...
const faqs = [
  { question: "Do I need technical knowledge to use ReportRun?",  answer: "No. ReportRun is designed for school administrators, not IT staff. If you can use WhatsApp, you can use ReportRun." },
  ...
  return (
    <>
      ...
      <section className="section-pad border-b border-border">
        <div className="container-page">
          <div className="max-w-xl mb-12">
            <SectionLabel>What ReportRun does</SectionLabel>
            <h2 className="text-3xl font-semibold text-text-primary mb-3">
              Every tool your admin office needs
            </h2>
            <p className="text-text-secondary">
