...
export const metadata: Metadata = {
  title: "Data Processing Agreement — EduNovtryx",
  description:
    "How EduNovtryx processes School, staff, student, and parent data as a data processor.",
};
...
const sections: LegalSection[] = [
    ...
    body: (
      <>
        <p>
          ...
          EduNovtryx (the &ldquo;Processor&rdquo;) for use of the Service, and
          governs EduNovtryx&rsquo;s processing of personal data that the
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <p>
          EduNovtryx is the data processor and processes that data only on
  ...
  },
  {
    ...
    body: (
      <>
        <p>
          The School authorises EduNovtryx to engage the following categories
        ...
        <p>
          EduNovtryx remains responsible for sub-processors&rsquo; compliance
  ...
  },
  {
    ...
    body: (
      <p>
        ...
        EduNovtryx will ensure appropriate safeguards are in place to protect
  ...
  },
  {
    ...
    body: (
      <p>
        ...
        required following a security incident, EduNovtryx will provide the
  ...
  },
  {
    ...
    body: (
      <p>
        ...
        remains in effect for as long as EduNovtryx processes personal data
  ...
  },
  {
    ...
    body: (
      <p>
        ...
        sent to <a href="mailto:info@novtryx.com">info@novtryx.com</a>.
      </p>
    ),
  },
];
    ...
    <LegalDocument
      ...
      intro={
        <p>
          ...
          and describes how EduNovtryx processes staff, student, and parent
